...
const testimonials = [
  {
    name: 'Ayşe K.',
    text: 'MyBodyRules sayesinde 6 ayda 12 kilo verdim ve çok daha enerjik hissediyorum! Planlar ve topluluk desteği harika.',
...
export default function Testimonials() {
  return (
    <section className="py-16 bg-white dark:bg-neutral-dark">
      <h2 className="text-3xl font-bold text-center mb-10 text-fitness-blue dark:text-fitness-green">Kullanıcı Başarı Hikâyeleri</h2>
            ...
            <SwiperSlide key={i}>
              <div className="flex flex-col items-center bg-neutral-light dark:bg-fitness-dark rounded-2xl shadow-lg p-8 animate-fade-in">
                <img
                  ...
                  onError={e => (e.currentTarget.src = 'https://ui-avatars.com/api/?name=' + encodeURIComponent(t.name))}
                />
                <p className="text-lg text-gray-700 dark:text-gray-200 mb-2 text-center">“{t.text}”</p>
